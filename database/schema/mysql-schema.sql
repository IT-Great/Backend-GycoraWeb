...
CREATE TABLE `users` (
  ...
  `usertype` enum('user','admin','superadmin','gudang','accounting') NOT NULL DEFAULT 'user',
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (3,'2026_04_05_104728_create_personal_access_tokens_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (4,'2026_04_06_031012_create_sessions_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (5,'2026_04_09_031541_add_variant_columns_to_products_table',3);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (6,'2026_04_09_062907_add_color_to_carts_table',4);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (7,'2026_04_10_070832_create_wishlists_table',5);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (8,'2026_04_11_025751_create_category_coas_table',6);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (9,'2026_04_11_025809_create_coas_table',7);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (10,'2026_04_11_053010_create_supplier_data_table',8);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (11,'2026_04_11_053040_create_invoice_suppliers_table',9);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (12,'2026_04_15_100918_create_clinic_treatments_table',10);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (13,'2026_04_16_041610_create_consultation_interactions_tables',11);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (14,'2026_04_16_090215_create_reviews_table',12);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (15,'2026_04_20_071448_create_messages_table',13);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (16,'2026_05_04_034111_create_promo_codes_table',14);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (17,'2026_05_04_081952_add_voucher_discount_price_to_products_table',15);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (18,'2026_05_07_090027_create_events_table',16);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (19,'2026_05_25_063830_add_expires_at_to_promo_claims_table',17);
